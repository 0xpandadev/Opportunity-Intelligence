...
function compileRequest(input, catalogs) {
  ...
  return {
    ...
    required_outputs: ['executive', 'megatrends', 'knowledge_graph', 'whitespaces', 'profit_pools', 'investment_routes', 'business_routes', 'scenarios', 'forecasts', 'evidence', 'counterarguments', 'methodology', 'limitations'],
    evidence_policy: {
