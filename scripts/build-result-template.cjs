...
const template = {
  ...
  megatrends:[], knowledge_graph:{ nodes:[], edges:[] }, whitespaces:[], profit_pools:[], investment_routes:[], business_routes:[], scenarios:[], forecasts:[], evidence:[], counterarguments:[], methodology:[], limitations:[]
};
